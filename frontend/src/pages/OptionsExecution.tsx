...
export function OptionsExecution() {
  ...
  return (
    <div className={styles.page}>
      ...
      {/* Current-month figure only — this page is scoped to "what should
          I do today, am I on pace" (see OPTIONS-EXECUTION-PAGE-SPEC.md).
          The historical breakdown (chart + all-time + events) lives on
          the Investments page instead; putting it here broke the page's
          own scope (Neel, 2026-07-22). */}
      <AssignmentLossThisMonth />
