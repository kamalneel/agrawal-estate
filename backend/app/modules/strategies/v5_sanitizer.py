"""
V5 Sanitizer - Converts numpy/Decimal types to JSON-safe Python types.
...
Copied from v4_sanitizer.py for version isolation - see
docs/ALGORITHM-UPGRADE-BEST-PRACTICES.md Pitfall 13.
"""
